...
const contactMethods = [
  {
    ...
    value: "alkaifk86@gmail.com",
    link: "mailto:alkaifk86@gmail.com",
  ...
  },
  {
    ...
    value: "Indore, Mp",
    link: "#Indore, Madhya Pradesh, and India",
...
export function PremiumContact() {
  ...
  const fadeInUp: Variants = {
    ...
    visible: {
      ...
      transition: {
        duration: 0.6,
        ease: [0.6, -0.05, 0.01, 0.99], // Must be an easing function name or array of numbers
      },
    },
  };
